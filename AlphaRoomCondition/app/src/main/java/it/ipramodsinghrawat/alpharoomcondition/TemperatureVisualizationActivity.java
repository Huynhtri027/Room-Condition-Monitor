...
public class TemperatureVisualizationActivity extends SuperDrawerActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temperature_visualization);
    ...
    public void getJSONObjectFromUrl(){
        ...
        String url = thingsSpeakUrl+dataChannel+"/fields"+"/2.json?api_key="+thingsSpeakReadAPIKey;
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int j = 0; j < feeds.length(); j++) {
                                ...
                                String tmp = feed.getString("field2");

                                //dataPoint[j] = new DataPoint(j, Float.parseFloat(tmp));
                                //dataPoint2[j] = new DataPoint(j, Float.parseFloat(tmp));
                                //horizontalLabels[j] = "L"+j+tmp;
                                ...
                                sensorRecordsList.add(new SensorRecord(0,Float.parseFloat(tmp), 0,
                                        dateTime));
                                //sensorRecordsList.add(new SensorRecord(Float.parseFloat(tmp),0,0,feed.getString("created_at")));
                            }
                            ...
                            plotLineGraphViewType(graphView,dataPoint,horizontalLabels,"Temperature");

                            String[] tableColumn = { "#", (char) 0x00B0+" C", "DateTime"};
...
*/
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                ...
                Toast.makeText(getApplicationContext(), "Temperature:" + sensorRecordsList.get(index).getTemperature()+(char) 0x00B0 +" C, Time: "+sensorRecordsList.get(index).getDateTime(), Toast.LENGTH_LONG).show();
                //Toast.makeText(getApplicationContext(), "Temperature:" + dataPoint+", Time: "+dataPointDateTime[index], Toast.LENGTH_SHORT).show();
            }
        });
